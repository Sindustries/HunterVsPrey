...
//-----------------------------------
//-SAVE HELMET & BACKBACK CONTENTS & ADD PARACHUTE IF PLAYER HAS EXISTING BACKPACK		H_PilotHelmetFighter_O
...
if (!isNull (unitBackpack player) && (backpack player) != "b_parachute") then {
	...
	if (HVPGameType isEqualTo 2 || HVPGameType isEqualTo 3 && playerSide != resistance) then {
