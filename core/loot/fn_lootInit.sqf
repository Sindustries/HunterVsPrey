...
if (HVPGameType isEqualTo 1) then {
	HVP_lootChance = ["lootSpawn_HVPchance"] call HVP_fnc_getSetting;
};
if (HVPGameType isEqualTo 2 || HVPGameType isEqualTo 3) then {
	HVP_lootChance = ["lootSpawn_CRUchance"] call HVP_fnc_getSetting;
};
...
[_pos,_size,HVP_lootChance,_zAdjustHouse,_zAdjustWild,_safePlace,_gunsWithMag,_chanceWild] call HVP_fnc_lootMain;
