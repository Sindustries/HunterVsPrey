	...
	private ["_artyPos","_vehCount","_missileCount","_type","_MLRS_vehArray","_MLRS_gunnerArray","_size","_aMarkername","_aMarkername2","_artilleryMarker","_artilleryMarker2","_MLRSgroup","_pos","_MLRS","_MLRSgunner"];
